...
public class ProductManager extends CommonManager {
    ...
    public static List<Product> searchProductBySolr(SolrClient solrClient, MongoDBClient mongoClient, String city,
            List<Integer> categoryList, boolean todayOnly, String keyword, int startOffset, int maxCount, Double price) {
    ...
    public static List<Product> searchProductBySolr(SolrClient solrClient, MongoDBClient mongoClient, String city,
            List<Integer> categoryList, boolean todayOnly, String keyword, int startOffset, int maxCount) {

        List<Product> list = searchProductBySolr(solrClient, mongoClient, city, categoryList, todayOnly, keyword,
                startOffset, maxCount, null);
        return list;
    }
